...
#pragma pack(push, 1)
    struct Construction
    {
        ...
        uint8_t var_17A[8];       // 0x00017A (0x00525F92) first byte stores the last signal mode
...
#pragma pack(push, 1)
    ...
    struct GeneralState
    {
        ...
        uint8_t defaultRailroadObjectId;                    // 0x000192 (0x00525FAA)
        uint8_t defaultRoadObjectId;                        // 0x000193 (0x00525FAB)
        ...
        uint8_t defaultTreeObjectId;                        // 0x000199 (0x00525FB1)
        ...
        uint8_t defaultLandObjectId;                        // 0x00019E (0x00525FB6)
        ...
        uint8_t defaultMiscBuildingObjectId;                // 0x0001B1 (0x00525FC9)
        uint8_t defaultWallObjectId;                        // 0x0001B2 (0x00525FCA)
        ...
        uint8_t defaultBuildVehicleType;                    // 0x000414 (0x0052622C)
